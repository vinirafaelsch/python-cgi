...
echo "<a class='button is-link buttons' href='http://localhost/redes2/admin/controllerUsers.cgi?action=create'>Novo Usuario</a>"
echo "<a class='button is-link buttons' href='http://localhost/redes2/admin/controllerUsers
.cgi?action=list'>Listar Usuarios</a>"
echo "<a class='button is-link buttons' href='http://localhost/redes2/admin/controllerUsers
.cgi?action=delete'>Excluir Usuario</a>"
echo "<br /><br />"
